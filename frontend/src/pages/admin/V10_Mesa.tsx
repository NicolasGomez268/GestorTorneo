...
export default function V10_Mesa() {
  ...
  useEffect(() => {
    ...
    const jugsLocal = jugadores
      .filter((j) => j.equipoId === local.id)
      .sort((a, b) => a.apellido.localeCompare(b.apellido))
    const jugsVisitante = jugadores
      .filter((j) => j.equipoId === visitante.id)
      .sort((a, b) => a.apellido.localeCompare(b.apellido))
  ...
  }, [partidoId, partidos, equipos, jugadores])
...
function PlanillaRow({
  entrada, esTitular, puedeSerTitular,
